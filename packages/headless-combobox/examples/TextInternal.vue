...
<template>
  <div class="w-full max-w-sm">
    <HeadlessCombobox
      v-slot="{
        filteredOptions, highlightedIndex, isSelected, selectedList,
    ...
    >
      <fieldset
        ...
        class="fieldset"
      >
        <legend :id="labelId" class="fieldset-legend">Framework (single, no v-model)</legend>
        <button
          :ref="setTriggerRef"
          v-bind="triggerProps"
        ...
        >
          <span :class="{ 'text-base-content/70': selectedList.length === 0 }">
