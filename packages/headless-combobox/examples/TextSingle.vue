...
export const title = 'Text options · single · no filter';
export const description = 'A list of plain string options, single selection, no search input.';
</script>
  ...
  <div class="w-full max-w-sm">
    ...
    >
      <fieldset
        ...
        class="fieldset"
      >
        <legend :id="labelId" class="fieldset-legend">Framework (single, no filter)</legend>
        <button
          :ref="setTriggerRef"
          v-bind="triggerProps"
